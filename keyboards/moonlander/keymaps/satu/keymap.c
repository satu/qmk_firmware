...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    KC_LEFT,                                        TD(DANCE_16),   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   KC_MINUS,       KC_EQUAL,       
    KC_TAB,         KC_Q,           TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TG(3),                                          TG(3),          TD(DANCE_21),   TD(DANCE_22),   TD(DANCE_23),   TD(DANCE_24),   TD(DANCE_25),   KC_BSLASH,      
    KC_ESCAPE,      TD(DANCE_9),    LCTL_T(KC_S),   LALT_T(KC_D),   LGUI_T(KC_F),   TD(DANCE_10),   KC_DELETE,                                                                      KC_MEH,         TD(DANCE_26),   RGUI_T(KC_J),   RALT_T(KC_K),   RCTL_T(KC_L),   LT(2,KC_SCOLON),KC_QUOTE,       
    KC_LSHIFT,      TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),                                   TD(DANCE_27),   TD(DANCE_28),   KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,      
    KC_TRANSPARENT, WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,       KC_LALT,                                                                                                        LCTL_T(KC_ESCAPE),KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),          
    KC_SPACE,       KC_BSPACE,      KC_LGUI,                        KC_RALT,        KC_TAB,         KC_ENTER
  ),
  [1] = LAYOUT_moonlander(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT,                                 KC_F6,          KC_F7,          KC_F8,          KC_F8,          KC_F10,         KC_F11,         KC_F12,         
  ...
  [2] = LAYOUT_moonlander(
    ...
    MU_MOD,         KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_AUDIO_VOL_UP,KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,  KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_WWW_BACK
  ),
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_LEFT,                                        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_DELETE,                                                                      KC_TRANSPARENT, KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_TRANSPARENT, 
...
void dance_1_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[1].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_2)); break;
...
void dance_1_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[1].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_2)); break;
...
void dance_15_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_B)); break;
...
void dance_15_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_B)); break;
...
void dance_16_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_6)); break;
...
void dance_16_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_6)); break;
...
void dance_17_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_7)); break;
...
void dance_17_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_7)); break;
...
void dance_18_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[18].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_8)); break;
...
void dance_18_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[18].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_8)); break;
...
void dance_19_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_9)); break;
...
void dance_19_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_9)); break;
...
void dance_20_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[20].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_0)); break;
...
void dance_20_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[20].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_0)); break;
...
void dance_21_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[21].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_Y)); break;
...
void dance_21_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[21].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_Y)); break;
...
void dance_22_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[22].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_U)); break;
...
void dance_22_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[22].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_U)); break;
...
void dance_23_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[23].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_I)); break;
...
void dance_23_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[23].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_I)); break;
...
void dance_24_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[24].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_O)); break;
...
void dance_24_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[24].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_O)); break;
...
void dance_25_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[25].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_P)); break;
...
void dance_25_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[25].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_P)); break;
...
void dance_26_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[26].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_H)); break;
...
void dance_26_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[26].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_H)); break;
...
void dance_27_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[27].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_N)); break;
...
void dance_27_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[27].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_N)); break;
...
void dance_28_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[28].step) {
        ...
        case SINGLE_HOLD: register_code16(RGUI(KC_M)); break;
...
void dance_28_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[28].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RGUI(KC_M)); break;
